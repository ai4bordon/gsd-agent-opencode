...
description: Инициализировать новый проект с глубоким сбором контекста и PROJECT.md
subtask: true
tools:
  - read
  - bash
...
@gsd-agent-opencode/get-shit-done/references/questioning.md
@gsd-agent-opencode/get-shit-done/references/ui-brand.md
@gsd-agent-opencode/get-shit-done/templates/project.md
@gsd-agent-opencode/get-shit-done/templates/requirements.md
...
RALF Lite defaults are global and loaded from `${OPENCODE_CONFIG_DIR:-~/.config/opencode}/get-shit-done/config.json`.
Do not add `ralf_lite` into `.planning/config.json` unless the user explicitly wants a project-specific override.
