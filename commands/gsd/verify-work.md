...
description: Проверить реализованные фичи через conversational UAT
subtask: true
...
<execution_context>
@gsd-agent-opencode/get-shit-done/workflows/verify-work.md
@gsd-agent-opencode/get-shit-done/templates/UAT.md
</execution_context>
