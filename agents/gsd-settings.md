...
Global runtime config (not managed by this command):
- `${OPENCODE_CONFIG_DIR:-~/.config/opencode}/get-shit-done/config.json` — shared RALF Lite defaults
...
- RALF Lite global defaults are edited in get-shit-done global config, not in this menu
