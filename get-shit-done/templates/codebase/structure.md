...
**Entry Points:**
- `bin/gsd.js` - CLI entry point (install/update/uninstall)
...
**Core Logic:**
- `bin/gsd.js` - Installation logic (file copying, path replacement)
...
- Usage: Reference from command with `@gsd-agent-opencode/get-shit-done/workflows/{name}.md`
...
- Source: Copied by gsd-agent-opencode installer during installation
